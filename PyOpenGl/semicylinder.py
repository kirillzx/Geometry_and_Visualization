...
def draw(*args, **kwargs):
    ...
    for i in range(11):
        glVertex3d(R*cos(i*2*pi/20), R*sin(i*2*pi/20), 0)
        glVertex3d(R*cos((i+1)*2*pi/20), R*sin((i+1)*2*pi/20), 1)
    glColor3f(1, 0, 1)    
    glVertex3d(R*cos(11*2*pi/20), R*sin(11*2*pi/20), 0)
    glVertex3d(R*cos(11*2*pi/20), R*sin(11*2*pi/20), 1)
    glVertex3d(R*cos(0), R*sin(0), 0)
    glVertex3d(R*cos(0), R*sin(0), 1)
    glEnd()
