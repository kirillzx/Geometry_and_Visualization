...
def draw(*args, **kwargs):
    ...
    glBegin(GL_QUADS)
    for i in range(0, 11):
        best_cubes(i*0.2 - 1, 0, 0, 0.2, [(11-i)*1/11, i*1/11,i*1/11])
        
    for i in range(0, 11):
        best_cubes(0, i*0.2 - 1, 0, 0.2, [i*1/11, (11-i)*1/11, i*1/11])
        
    for i in range(0, 11):
        best_cubes(0, 0, i*0.2 - 1, 0.2, [i*1/11, i*1/11,(11-i)*1/11])    
